...
public class AcoesGerente extends JFrame {
	...
	private double Renda, emprestimo, valorrequerido, propostafinal;
	...
	public AcoesGerente(int cod, String agencia,String UF, String id, String senhaf) throws ClassNotFoundException, SQLException {
		...
		switch (cod) {
			case 1: //criar conta
				...
				JButton BotaoMenuG = new JButton("Voltar para o Menu do Gerente");
				BotaoMenuG.addActionListener(new ActionListener() {
		        	public void actionPerformed(ActionEvent e) {
		        		MenuGerente mg = null;
						try {
				...
				BotaoMenuG.setFont(new Font("Bahnschrift", Font.PLAIN, 14));
				BotaoMenuG.setBounds(10, 518, 241, 27);
		        contentPane.add(BotaoMenuG);
			...
			case 2: //excluir conta
				...
				JButton BotaoMenuG1 = new JButton("Voltar para o Menu do Gerente");
				BotaoMenuG1.addActionListener(new ActionListener() {
		        	public void actionPerformed(ActionEvent e) {
		        		MenuGerente mg = null;
						try {
							mg = new MenuGerente(agencia,id);
				...
				BotaoMenuG1.setFont(new Font("Bahnschrift", Font.PLAIN, 14));
				BotaoMenuG1.setBounds(10, 518, 241, 27);
		        contentPane.add(BotaoMenuG1);
			...
			case 3: //avaliar emprestimos
				...
				JButton btnNewButton_3 = new JButton("Autorizar empréstimo");
				JButton btnNewButton_3_1 = new JButton("Negar empréstimo");
				...
				for(int i = 0; i < pedidosdeemprestimo.size(); i++) {
					pedidos.addElement("Dados do pedido: Num. da conta: " + pedidosdeemprestimo.get(i)[0] + " | Valor do pedido: R$" + pedidosdeemprestimo.get(i)[6]);
				}
				...
				comboBox.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						double divida = Double.parseDouble(pedidosdeemprestimo.get(i)[4]);
						double valorp = Double.parseDouble(pedidosdeemprestimo.get(i)[5]);
						valorrequerido = Double.parseDouble(pedidosdeemprestimo.get(i)[6]);
						double saldo = Double.parseDouble(pedidosdeemprestimo.get(i)[3]);
						double renda = Double.parseDouble(pedidosdeemprestimo.get(i)[2]);
						propostafinal = Double.parseDouble(pedidosdeemprestimo.get(i)[8]);
						textArea_1.append("Dados do pedido: Num. da conta: " + pedidosdeemprestimo.get(i)[0] + "\nTp de conta: " + pedidosdeemprestimo.get(i)[1] + "\nRenda: R$" + df.format(renda) + "\nSaldo: R$" + df.format(saldo) + "\nDívida: R$" + df.format(divida) + "\nValor pré-disponibilizado: R$" + df.format(valorp) + "\nValor pedido: R$" + df.format(valorrequerido) + "\n Quantidade de parcelas: " + pedidosdeemprestimo.get(i)[7] + "\n Valor da proposta: R$" + df.format(propostafinal));
						conta = pedidosdeemprestimo.get(i)[0];
				...
				btnNewButton_3.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						// emprestimo = false
						try {
							g3.autorizaemprestimo(conta,valorrequerido,propostafinal);
							FinalGerente fg = new FinalGerente ("3.1",agencia,id);
							fg.setVisible(true);
							dispose();
				...
				btnNewButton_3.setBounds(535, 272, 207, 34);
				...
				btnNewButton_3_1.setBounds(535, 316, 207, 34);
				...
				JButton BotaoMenuG2 = new JButton("Voltar para o Menu do Gerente");
				BotaoMenuG2.addActionListener(new ActionListener() {
		        	public void actionPerformed(ActionEvent e) {
		        		MenuGerente mg = null;
						try {
							mg = new MenuGerente(agencia,id);
				...
				BotaoMenuG2.setFont(new Font("Bahnschrift", Font.PLAIN, 14));
				BotaoMenuG2.setBounds(731, 518, 231, 27);
		        contentPane.add(BotaoMenuG2);
